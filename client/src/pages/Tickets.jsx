  ...
  return (
    <div className="w-full min-h-screen bg-gold/10">
      ...
      <main className="max-w-5xl mx-auto px-4 py-10">
        ...
        {/* EXTRA INFO SECTION - FIXED */}
        <div className="bg-primary rounded-xl shadow-lg p-6 mt-10 text-center">
          <h2 className="text-xl font-bold text-gold mb-3">Additional Information</h2>

          <p className="text-cream">
            All tickets allow full-day access to the Paisley Highland Games, including events,
            vendors, and live entertainment. Tickets can be shown digitally on your phone.
          </p>
        </div>
